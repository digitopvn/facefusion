...
face_selector_orders: List[FaceSelectorOrder] = [
    "left-right",
    "right-left",
    "top-bottom",
    "bottom-top",
...
output_audio_encoders: List[OutputAudioEncoder] = [
    "aac",
    "libmp3lame",
    "libopus",
    "libvorbis",
]
output_video_encoders: List[OutputVideoEncoder] = [
    "libx264",
    "libx265",
    "libvpx-vp9",
    "h264_nvenc",
...
output_video_presets: List[OutputVideoPreset] = [
    "ultrafast",
    "superfast",
    "veryfast",
    "faster",
