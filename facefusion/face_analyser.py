...
from facefusion.face_landmarker import (
...
def create_faces(
    ...
    for index in keep_indices:
        ...
        if state_manager.get_item("face_landmarker_score") > 0:
            face_landmark_68, face_landmark_score_68 = detect_face_landmarks(
    ...
    for vision_frame in vision_frames:
        if numpy.any(vision_frame):
            ...
            if static_faces:
                ...
                for face_detector_angle in state_manager.get_item(
                    ...
                    if face_detector_angle == 0:
                        ...
                        bounding_boxes, face_scores, face_landmarks_5 = (
                            detect_rotated_faces(vision_frame, face_detector_angle)
                        )
                ...
                if (
                    all_bounding_boxes
                    and all_face_scores
                    and all_face_landmarks_5
                    and state_manager.get_item("face_detector_score") > 0
                ):
